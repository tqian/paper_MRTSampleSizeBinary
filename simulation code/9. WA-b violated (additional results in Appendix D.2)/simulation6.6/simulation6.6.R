...
if (0) {
    ...
    result %>% 
        ...
        facet_grid(ft_t_shape + ft_w_shape ~ gt_t_shape + gt_w_shape + ft_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu6.6_power_gtwtheta.pdf"), width = 10, height = 7.5)
    ...
    result %>% 
        ...
        facet_grid(ft_t_shape + ft_w_shape ~ gt_t_shape + gt_w_shape + ft_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu6.6_power_gtttheta.pdf"), width = 10, height = 7.5)
    ...
    result %>%
        ...
        facet_grid(ft_t_shape + ft_w_shape ~ gt_t_shape + gt_w_shape + ft_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu6.6_power_gtttheta_minus_gtwtheta.pdf"), width = 10, height = 7.5)
    ...
    result %>% 
        ...
        facet_grid(ft_t_shape + ft_w_shape ~ gt_t_shape + gt_w_shape + ft_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu6.6_typeierror_gtwtheta.pdf"), width = 10, height = 7.5)
    ...
    result %>% 
        ...
        facet_grid(ft_t_shape + ft_w_shape ~ gt_t_shape + gt_w_shape + ft_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu6.6_typeierror_gtttheta.pdf"), width = 10, height = 7.5)
}
