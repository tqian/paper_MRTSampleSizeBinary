...
if (0) {
    ...
    # result2 <- readRDS(paste0("../simulation2.6.1/result_df_collected_nsim", nsim, ".RDS"))
    ...
    result %>% 
        ...
        facet_grid(gt_t_shape + gt_w_shape ~ ft_t_shape + ft_w_shape + gt_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu2.6_power_ftwtheta.pdf"), width = 10, height = 7.5)
    ...
    result %>% 
        ...
        facet_grid(gt_t_shape + gt_w_shape ~ ft_t_shape + ft_w_shape + gt_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu2.6_power_ftttheta.pdf"), width = 10, height = 7.5)
    ...
    result %>%
        ...
        facet_grid(gt_t_shape + gt_w_shape ~ ft_t_shape + ft_w_shape + gt_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu2.6_power_ftttheta_minus_ftwtheta.pdf"), width = 10, height = 7.5)
    ...
    result %>% 
        ...
        facet_grid(gt_t_shape + gt_w_shape ~ ft_t_shape + ft_w_shape + gt_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu2.6_typeierror_ftwtheta.pdf"), width = 10, height = 7.5)
    ...
    result %>% 
        ...
        facet_grid(gt_t_shape + gt_w_shape ~ ft_t_shape + ft_w_shape + gt_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu2.6_typeierror_ftttheta.pdf"), width = 10, height = 7.5)
}
