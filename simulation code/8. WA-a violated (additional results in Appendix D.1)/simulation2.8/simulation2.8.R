...
if (0) {
    ...
    result %>% 
        ...
        facet_grid(gt_t_shape + gt_w_shape ~ ft_t_shape + ft_w_shape + gt_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu2.8_power_ftwtheta.pdf"), width = 10, height = 7.5)
    ...
    result %>% 
        ...
        facet_grid(gt_t_shape + gt_w_shape ~ ft_t_shape + ft_w_shape + gt_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu2.8_power_ftttheta.pdf"), width = 10, height = 7.5)
    ...
    result %>%
        ...
        facet_grid(gt_t_shape + gt_w_shape ~ ft_t_shape + ft_w_shape + gt_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu2.8_power_ftttheta_minus_ftwtheta.pdf"), width = 10, height = 7.5)
    ...
    result %>% 
        ...
        facet_grid(gt_t_shape + gt_w_shape ~ ft_t_shape + ft_w_shape + gt_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu2.8_typeierror_ftwtheta.pdf"), width = 10, height = 7.5)
    ...
    result %>% 
        ...
        facet_grid(gt_t_shape + gt_w_shape ~ ft_t_shape + ft_w_shape + gt_t_theta,
                   labeller = label_both) +
        theme_bw() + myggfont()
    ggsave(paste0("plot_simu2.8_typeierror_ftttheta.pdf"), width = 10, height = 7.5)
}
